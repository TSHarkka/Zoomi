...
public class Scrollview3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scrollview3);
    ...
    public void navToPlayer2(View view) {
        ...
        Scrollview3.this.startActivity(intentToScrollview2);
    }

    public void navToPlayer3(View view) {
        Intent intentToScrollview3 = new Intent(this, Scrollview.class);
        Scrollview3.this.startActivity(intentToScrollview3);
    }

    public void navToPlayer4(View view) {
        Intent akt=null;
        akt = new Intent(Scrollview3.this, Scrollview4.class);
        startActivity(akt);
    }
}
